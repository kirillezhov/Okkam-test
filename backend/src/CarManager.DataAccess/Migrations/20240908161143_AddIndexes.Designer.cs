...
namespace CarManager.DataAccess.Migrations
{
    ...
    [Migration("20240908161143_AddIndexes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarManager.Domain.Models.BodyType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CarManager.Domain.Models.Car", b =>
                {
                    b.HasOne("CarManager.Domain.Models.BodyType", "BodyType")
                        .WithMany()
                        .HasForeignKey("BodyTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarManager.Domain.Models.Brand", "Brand")
                        .WithMany("Cars")
